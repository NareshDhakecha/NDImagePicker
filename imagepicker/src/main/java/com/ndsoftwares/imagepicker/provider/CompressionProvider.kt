...
import com.ndsoftwares.imagepicker.util.ExifDataCopier
import com.ndsoftwares.imagepicker.util.FileUtil
import com.ndsoftwares.imagepicker.util.ImageUtil
...
class CompressionProvider(activity: ImagePickerActivity) : BaseProvider(activity) {
    ...
    init {
        ...
        mMaxFileSize = bundle.getLong(NDImagePicker.EXTRA_IMAGE_MAX_SIZE, 0)
...
//        }.execute(uri)
        ...
        // for running long process in background
